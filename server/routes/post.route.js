...
import { createPost, getAllPost, getPostById, deletePost, getUserPost, toggleLike, addComment } from "../controllers/post.controller.js";
...
// comment on a post rest api
router.route('/posts/:id/comment').post(isAuthenticated, addComment);
