            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24">
                  <path
                    d="M12.0003 4.75C13.7703 4.75 15.3553 5.36 16.6053 6.55L20.0303 3.125C17.9503 1.19 15.2353 0 12.0003 0C7.31031 0 3.25531 2.69 1.28031 6.61L5.27031 9.705C6.21531 6.86 8.87031 4.75 12.0003 4.75Z"
                    fill="#4285F4"
                  />
                  <path
                    d="M23.49 12.275C23.49 11.49 23.415 10.73 23.3 10H12V14.51H18.69C18.36 16.01 17.44 17.22 16.06 18.01L19.47 20.785C21.93 18.495 23.49 15.605 23.49 12.275Z"
                    fill="#34A853"
                  />
                  <path
                    d="M5.27 14.295C4.97 13.575 4.79 12.805 4.79 12C4.79 11.195 4.97 10.425 5.26 9.705L1.27 6.61C0.46 8.475 0 10.575 0 12.775C0 14.975 0.46 17.075 1.27 18.94L5.27 15.845C5.27 15.845 5.27 14.295 5.27 14.295Z"
                    fill="#FBBC05"
                  />
                  <path
                    d="M12 23.5C15.105 23.5 17.78 22.435 19.675 20.785L16.27 18.01C15.17 18.695 13.71 19.125 12 19.125C8.87 19.125 6.215 17.015 5.27 14.17L1.28 17.265C3.255 21.185 7.31 23.5 12 23.5Z"
                    fill="#EA4335"
                  />
                </svg>
                <span>Google</span>
